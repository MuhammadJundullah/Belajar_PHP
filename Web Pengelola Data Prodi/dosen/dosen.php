...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-transparent shadow-sm fixed-top">
      <div class="container">
        <a class="navbar-brand" href="#">Daftar Data Dosen</a>
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
		  ...
		  <li class="nav-item ms-3">
            ...
            <li class="nav-item ms-3">
				<a class="nav-link text-primary fw-bold" href="dosen.php">Dosen</a>
            </li>
            <li class="nav-item ms-3">
			...
			<?php foreach ($table as $row) : ?>
				<tr class="align-middle">
					...
					<td>
						...
						<button type="button" class="btn btn-primary" style="margin-left: 5px;"><a style="text-decoration: none;" href="ubah.php?id=<?php echo $row["id"]?>&kode=<?php echo $row["kode_dosen"]?>&nama=<?php echo $row["nama_dosen"]?>&email=<?php echo $row["email"]?>" class="text-light">Ubah</a></button>
					</td>
				</tr>
			<?php $i ++;?>
			<?php endforeach; ?>
