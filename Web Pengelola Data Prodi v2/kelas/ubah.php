...
<body>
  ...
  <!-- Footer -->
  <p style="margin-bottom: -1px; padding-top: 20rem" class="text-secondary small text-center">© 2024 Sayid Muhammad Jundullah. All rights reserved.</p>
  <!-- Footer -->
